...
public class CommandStatus {
	...
	public static final String SUCCESS = "Your request successfully processed";
	...
	public static final String INCOMPLETE_ADDRESS_DETAILS = "Incomplete Address Details";
